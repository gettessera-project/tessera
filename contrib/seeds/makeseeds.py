...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of tessera node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple tessera ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple tessera ports', file=sys.stderr)
