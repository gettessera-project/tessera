...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('// Copyright (c) 2026 tessera core\n')
    g.write('// See COPYING for license.\n\n')
    g.write('#ifndef TESSERA_CHAINPARAMSSEEDS_H\n')
    g.write('#define TESSERA_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the tessera network\n')
    ...
    g.write('#endif // TESSERA_CHAINPARAMSSEEDS_H\n')
