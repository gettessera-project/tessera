...
complete --command tessera-qt --no-files

# Extract options
function __fish_tesseraqt_get_options
...
complete \
    --command tessera-qt \
    --arguments "(__fish_tesseraqt_get_options --nofiles)"
