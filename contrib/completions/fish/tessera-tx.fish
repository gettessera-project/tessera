...
# Extract options
function __fish_tessera_tx_get_options
...
# Extract commands
function __fish_tessera_tx_get_commands
...
complete \
    --command tessera-tx \
    --condition "not __fish_tessera_seen_cmd (__fish_tessera_tx_get_commands --commandsonly)" \
    --arguments "(__fish_tessera_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command tessera-tx \
    --arguments "(__fish_tessera_tx_get_commands)" \
    --no-files
