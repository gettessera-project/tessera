...
complete --command tesserad --no-files

# Extract options
function __fish_tesserad_get_options
...
complete \
    --command tesserad \
    --arguments "(__fish_tesserad_get_options --nofiles)"
