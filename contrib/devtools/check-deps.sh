...
declare -A LIBS
LIBS[cli]="libtessera_cli.a"
LIBS[common]="libtessera_common.a"
LIBS[consensus]="libtessera_consensus.a"
LIBS[crypto]="libtessera_crypto.a"
LIBS[node]="libtessera_node.a"
LIBS[util]="libtessera_util.a"
LIBS[wallet]="libtessera_wallet.a"
