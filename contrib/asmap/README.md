...
be used in Tessera with the `-asmap` option.
...
to binary before being used with Tessera.
...
the `tessera-cli getnodeaddresses` command.
...
```
tessera-cli getnodeaddresses 0 > addrs.json
```
