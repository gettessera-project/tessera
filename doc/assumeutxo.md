...
Assumeutxo is a feature that allows fast bootstrapping of a validating tesserad
instance.
...
```
$ tessera-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ tessera-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
