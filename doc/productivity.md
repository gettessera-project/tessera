...
```sh
cmake --build build --target tesserad tessera-cli
cmake --build build --target tessera-qt
cmake --build build --target bench_tessera
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:MarcoFalke/tessera.git
```
...
> e.g. github.com/MarcoFalke/tessera.git
