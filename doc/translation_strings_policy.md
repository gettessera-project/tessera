...
This document provides guidelines for internationalization of the Tessera software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Tessera network</numerusform>
            <numerusform>%n active connections to Tessera network</numerusform>
        </translation>
    </message>
...
This can be checked by building the `translate` target with `cmake` ([instructions](translation_process.md)), then verifying that `tessera_en.ts` remains unchanged.
