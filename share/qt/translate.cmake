...
function(extract_strings output)
  ...
  file(STRINGS "tesserastrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *tessera_strings[] = {
]])

  set(prefix "QT_TRANSLATE_NOOP(\"tessera-core\", \"")
  set(suffix "\"),\n")
...
set(subtrees crc32c crypto/ctaes leveldb minisketch ML-DSA-44 ML-KEM-768)
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/tesserastrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/tesserastrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/tessera_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/tessera_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/tessera_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/tessera_en.xlf" tessera_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" tessera_en "${tessera_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" tessera_en "${tessera_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/tessera_en.xlf" "${tessera_en}")
