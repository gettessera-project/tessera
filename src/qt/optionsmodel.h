...
#ifndef TESSERA_QT_OPTIONSMODEL_H
#define TESSERA_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Tessera client.
...
public:
    ...
    TesseraUnit getDisplayUnit() const { return m_display_tessera_unit; }
...
private:
    ...
    QString language;
    TesseraUnit m_display_tessera_unit;
...
Q_SIGNALS:
    void displayUnitChanged(TesseraUnit unit);
...
#endif // TESSERA_QT_OPTIONSMODEL_H
