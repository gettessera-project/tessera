...
#ifndef TESSERA_QT_GUIUTIL_H
#define TESSERA_QT_GUIUTIL_H
...
/** Utility functions used by the Tessera Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "tessera:" URI into recipient object, return true on successful parsing
