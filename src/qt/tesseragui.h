...
#ifndef TESSERA_QT_TESSERAGUI_H
#define TESSERA_QT_TESSERAGUI_H
...
/**
  Tessera GUI main class. This class represents the main window of the Tessera UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TesseraGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit TesseraGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~TesseraGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a tessera wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, TesseraUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(TesseraUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // TESSERA_QT_TESSERAGUI_H
