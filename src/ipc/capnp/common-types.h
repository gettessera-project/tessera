...
#ifndef TESSERA_IPC_CAPNP_COMMON_TYPES_H
#define TESSERA_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between tessera processes.
...
//! Functions to serialize / deserialize common tessera types.
namespace mp {
...
#endif // TESSERA_IPC_CAPNP_COMMON_TYPES_H
