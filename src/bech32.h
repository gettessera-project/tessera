...
//
// Vendored verbatim into Tessera: Bech32/Bech32m is a standard string codec with
// no curve dependency, so it is reused unchanged (only the include guard is
// renamed). The upstream MIT copyright is preserved as the license requires.
...
#ifndef TESSERA_BECH32_H
#define TESSERA_BECH32_H
