...
//
// Tessera — fixed-width little/big-endian integer load/store over raw byte
// storage. Byte order itself lives in compat/endian.h.

#ifndef TESSERA_CRYPTO_COMMON_H
#define TESSERA_CRYPTO_COMMON_H
