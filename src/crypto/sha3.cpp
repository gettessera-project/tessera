...
//
// The Keccak-f[1600] permutation: the round constants (RNDC) and rotation
// offsets are fixed by FIPS 202. Verified bit-exact against the NIST SHA3-256
// known-answer vectors — see test/test_sha3.cpp.
