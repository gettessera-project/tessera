 ...
 * for both tesserad and tessera-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Tessera");


#include <tessera-build-info.h>
// The <tessera-build-info.h>, which is generated by the build environment,
