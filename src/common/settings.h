...
#ifndef TESSERA_COMMON_SETTINGS_H
#define TESSERA_COMMON_SETTINGS_H
...
struct SettingsSpan {
    ...
    explicit SettingsSpan(const SettingsValue* data_, size_t size_) noexcept : data(data_), size(size_) {}
...
#endif // TESSERA_COMMON_SETTINGS_H
