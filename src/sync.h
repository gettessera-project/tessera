...
#ifndef TESSERA_SYNC_H
#define TESSERA_SYNC_H
...
#define REVERSE_LOCK(g, cs) typename std::decay<decltype(g)>::type::reverse_lock TESSERA_UNIQUE_NAME(revlock)(g, cs, #cs, __FILE__, __LINE__)
...
#define LOCK(cs) UniqueLock TESSERA_UNIQUE_NAME(criticalblock)(MaybeCheckNotHeld(cs), #cs, __FILE__, __LINE__)
