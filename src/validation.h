...
#ifndef TESSERA_VALIDATION_H
#define TESSERA_VALIDATION_H
...
private:
    ...
    SHA3_256 m_script_execution_cache_hasher;
...
public:
    ...
    SHA3_256 ScriptExecutionCacheHasher() const { return m_script_execution_cache_hasher; }
};
