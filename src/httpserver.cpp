...
using http_tessera::HTTPRequest;
...
static std::unique_ptr<http_tessera::HTTPServer> g_http_server{nullptr};
...
static void RejectRequest(std::unique_ptr<http_tessera::HTTPRequest> hreq)
{
