...
#ifndef TESSERA_UTIL_FS_HELPERS_H
#define TESSERA_UTIL_FS_HELPERS_H
 ...
 * It returns the actual file descriptor limit (which may be more or less than min_fd).
 */
...
#endif // TESSERA_UTIL_FS_HELPERS_H
