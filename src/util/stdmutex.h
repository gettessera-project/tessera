...
#ifndef TESSERA_UTIL_STDMUTEX_H
#define TESSERA_UTIL_STDMUTEX_H
...
#define STDLOCK(cs) StdMutex::Guard TESSERA_UNIQUE_NAME(criticalblock){StdMutex::CheckNotHeld(cs)}

#endif // TESSERA_UTIL_STDMUTEX_H
