...
LineReader::LineReader(std::span<const std::byte> buffer, size_t max_line_length_)
    : start(buffer.begin()), end(buffer.end()), max_line_length(max_line_length_), it(buffer.begin()) {}
